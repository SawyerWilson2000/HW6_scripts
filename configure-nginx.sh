...
sudo curl https://raw.githubusercontent.com/SawyerWilson2000/AzureVM/main/default | sudo tee -a /etc/nginx/sites-available/default
...
sudo git clone https://github.com/SawyerWilson2000/HW6_website.git
